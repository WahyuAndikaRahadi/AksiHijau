    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-sky-50">
      ...
      <nav className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* 💡 REVISI UTAMA: Tambahkan overflow-x-auto dan whitespace-nowrap */}
          <div className="flex overflow-x-auto whitespace-nowrap">
            {(
              ...
              <button
                ...
                // 💡 TAMBAHKAN flex-shrink-0 untuk mencegah tombol terpotong
                className={`px-6 py-4 font-semibold transition-all flex items-center gap-2 flex-shrink-0 ${
                  activeTab === tab.key
      ...
      <div className="flex gap-2 items-start">
        ...
        {event.status !== "PENDING" && (
          <button
            onClick={onDelete}
            disabled={isDeleting}
            className={`flex items-center gap-2 px-4 py-2 bg-gray-200 text-red-600 rounded-lg hover:bg-gray-300 text-sm font-semibold transition-colors flex-shrink-0 ${
              isDeleting ? "opacity-50 cursor-not-allowed" : ""
            }`}
          >
            {isDeleting ? (
